...
pub type R = crate::R<InputEnSpec>;
#[doc = "Register `input_en` writer"]
pub type W = crate::W<InputEnSpec>;
...
#[doc = "Pin Input Enable Register\n\nYou can [`read`](crate::Reg::read) this register and get [`input_en::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`input_en::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct InputEnSpec;
impl crate::RegisterSpec for InputEnSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`input_en::R`](R) reader structure"]
impl crate::Readable for InputEnSpec {}
