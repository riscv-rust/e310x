...
impl W {
    ...
    #[doc = "Bit 16"]
    #[inline(always)]
    pub fn pin16(&mut self) -> Pin16W<'_, HighIeSpec> {
        Pin16W::new(self, 16)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    pub fn pin17(&mut self) -> Pin17W<'_, HighIeSpec> {
        Pin17W::new(self, 17)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    pub fn pin18(&mut self) -> Pin18W<'_, HighIeSpec> {
        Pin18W::new(self, 18)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    pub fn pin19(&mut self) -> Pin19W<'_, HighIeSpec> {
        Pin19W::new(self, 19)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    pub fn pin20(&mut self) -> Pin20W<'_, HighIeSpec> {
        Pin20W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    pub fn pin21(&mut self) -> Pin21W<'_, HighIeSpec> {
        Pin21W::new(self, 21)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    pub fn pin22(&mut self) -> Pin22W<'_, HighIeSpec> {
        Pin22W::new(self, 22)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    pub fn pin23(&mut self) -> Pin23W<'_, HighIeSpec> {
        Pin23W::new(self, 23)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    pub fn pin24(&mut self) -> Pin24W<'_, HighIeSpec> {
        Pin24W::new(self, 24)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    pub fn pin25(&mut self) -> Pin25W<'_, HighIeSpec> {
        Pin25W::new(self, 25)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    pub fn pin26(&mut self) -> Pin26W<'_, HighIeSpec> {
        Pin26W::new(self, 26)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    pub fn pin27(&mut self) -> Pin27W<'_, HighIeSpec> {
        Pin27W::new(self, 27)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
    pub fn pin28(&mut self) -> Pin28W<'_, HighIeSpec> {
        Pin28W::new(self, 28)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    pub fn pin29(&mut self) -> Pin29W<'_, HighIeSpec> {
        Pin29W::new(self, 29)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    pub fn pin30(&mut self) -> Pin30W<'_, HighIeSpec> {
        Pin30W::new(self, 30)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn pin31(&mut self) -> Pin31W<'_, HighIeSpec> {
        Pin31W::new(self, 31)
    }
}
