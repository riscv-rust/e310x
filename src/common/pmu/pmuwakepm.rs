#[doc = "Reader of register pmuwakepm[%s]"]
pub type R = crate::R<u32, super::PMUWAKEPM>;
#[doc = "Writer for register pmuwakepm[%s]"]
pub type W = crate::W<u32, super::PMUWAKEPM>;
#[doc = "Register pmuwakepm[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::PMUWAKEPM {
    type Type = u32;
    #[inline(always)]
