...
pub struct RegisterBlock {
    ...
    pub pullup: crate::Reg<pullup::PULLUP_SPEC>,
    #[doc = "0x14 - Drive Strength Register"]
    pub drive: crate::Reg<drive::DRIVE_SPEC>,
...
pub mod output_val;
#[doc = "pullup register accessor: an alias for `Reg<PULLUP_SPEC>`"]
pub type PULLUP = crate::Reg<pullup::PULLUP_SPEC>;
#[doc = "Internal Pull-Up Enable Register"]
pub mod pullup;
#[doc = "drive register accessor: an alias for `Reg<DRIVE_SPEC>`"]
