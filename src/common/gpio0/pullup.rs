#[doc = "Reader of register pullup"]
pub type R = crate::R<u32, super::PULLUP>;
#[doc = "Writer for register pullup"]
pub type W = crate::W<u32, super::PULLUP>;
#[doc = "Register pullup `reset()`'s with value 0"]
impl crate::ResetValue for super::PULLUP {
    type Type = u32;
    #[inline(always)]
