...
pub type R = crate::R<RTCCMP_SPEC>;
#[doc = "Register `rtccmp` writer"]
pub type W = crate::W<RTCCMP_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<RTCCMP_SPEC> {
