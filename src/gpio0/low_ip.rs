...
pub type R = crate::R<LowIpSpec>;
#[doc = "Register `low_ip` writer"]
pub type W = crate::W<LowIpSpec>;
...
#[doc = "Low Interrupt Pending Register\n\nYou can [`read`](crate::Reg::read) this register and get [`low_ip::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`low_ip::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LowIpSpec;
impl crate::RegisterSpec for LowIpSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`low_ip::R`](R) reader structure"]
impl crate::Readable for LowIpSpec {}
