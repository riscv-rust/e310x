...
pub type R = crate::R<HIGH_IE_SPEC>;
#[doc = "Register `high_ie` writer"]
pub type W = crate::W<HIGH_IE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pin0(&mut self) -> PIN0_W<HIGH_IE_SPEC> {
        PIN0_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn pin1(&mut self) -> PIN1_W<HIGH_IE_SPEC> {
        PIN1_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn pin2(&mut self) -> PIN2_W<HIGH_IE_SPEC> {
        PIN2_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn pin3(&mut self) -> PIN3_W<HIGH_IE_SPEC> {
        PIN3_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn pin4(&mut self) -> PIN4_W<HIGH_IE_SPEC> {
        PIN4_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn pin5(&mut self) -> PIN5_W<HIGH_IE_SPEC> {
        PIN5_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn pin6(&mut self) -> PIN6_W<HIGH_IE_SPEC> {
        PIN6_W::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn pin7(&mut self) -> PIN7_W<HIGH_IE_SPEC> {
        PIN7_W::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn pin8(&mut self) -> PIN8_W<HIGH_IE_SPEC> {
        PIN8_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn pin9(&mut self) -> PIN9_W<HIGH_IE_SPEC> {
        PIN9_W::new(self, 9)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn pin10(&mut self) -> PIN10_W<HIGH_IE_SPEC> {
        PIN10_W::new(self, 10)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn pin11(&mut self) -> PIN11_W<HIGH_IE_SPEC> {
        PIN11_W::new(self, 11)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn pin12(&mut self) -> PIN12_W<HIGH_IE_SPEC> {
        PIN12_W::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn pin13(&mut self) -> PIN13_W<HIGH_IE_SPEC> {
        PIN13_W::new(self, 13)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn pin14(&mut self) -> PIN14_W<HIGH_IE_SPEC> {
        PIN14_W::new(self, 14)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn pin15(&mut self) -> PIN15_W<HIGH_IE_SPEC> {
        PIN15_W::new(self, 15)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn pin16(&mut self) -> PIN16_W<HIGH_IE_SPEC> {
        PIN16_W::new(self, 16)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn pin17(&mut self) -> PIN17_W<HIGH_IE_SPEC> {
        PIN17_W::new(self, 17)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn pin18(&mut self) -> PIN18_W<HIGH_IE_SPEC> {
        PIN18_W::new(self, 18)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn pin19(&mut self) -> PIN19_W<HIGH_IE_SPEC> {
        PIN19_W::new(self, 19)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn pin20(&mut self) -> PIN20_W<HIGH_IE_SPEC> {
        PIN20_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn pin21(&mut self) -> PIN21_W<HIGH_IE_SPEC> {
        PIN21_W::new(self, 21)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn pin22(&mut self) -> PIN22_W<HIGH_IE_SPEC> {
        PIN22_W::new(self, 22)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn pin23(&mut self) -> PIN23_W<HIGH_IE_SPEC> {
        PIN23_W::new(self, 23)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn pin24(&mut self) -> PIN24_W<HIGH_IE_SPEC> {
        PIN24_W::new(self, 24)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    #[must_use]
    pub fn pin25(&mut self) -> PIN25_W<HIGH_IE_SPEC> {
        PIN25_W::new(self, 25)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn pin26(&mut self) -> PIN26_W<HIGH_IE_SPEC> {
        PIN26_W::new(self, 26)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    #[must_use]
    pub fn pin27(&mut self) -> PIN27_W<HIGH_IE_SPEC> {
        PIN27_W::new(self, 27)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
    #[must_use]
    pub fn pin28(&mut self) -> PIN28_W<HIGH_IE_SPEC> {
        PIN28_W::new(self, 28)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    #[must_use]
    pub fn pin29(&mut self) -> PIN29_W<HIGH_IE_SPEC> {
        PIN29_W::new(self, 29)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    #[must_use]
    pub fn pin30(&mut self) -> PIN30_W<HIGH_IE_SPEC> {
        PIN30_W::new(self, 30)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn pin31(&mut self) -> PIN31_W<HIGH_IE_SPEC> {
        PIN31_W::new(self, 31)
    }
...
#[doc = "High Interrupt Enable Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`high_ie::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`high_ie::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
