...
pub type R = crate::R<DriveSpec>;
#[doc = "Register `drive` writer"]
pub type W = crate::W<DriveSpec>;
...
#[doc = "Drive Strength Register\n\nYou can [`read`](crate::Reg::read) this register and get [`drive::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`drive::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DriveSpec;
impl crate::RegisterSpec for DriveSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`drive::R`](R) reader structure"]
impl crate::Readable for DriveSpec {}
#[doc = "`write(|w| ..)` method takes [`drive::W`](W) writer structure"]
impl crate::Writable for DriveSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets drive to value 0"]
impl crate::Resettable for DriveSpec {
