...
pub type R = crate::R<WRITE_EN_SPEC>;
#[doc = "Register `write_en` writer"]
pub type W = crate::W<WRITE_EN_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<WRITE_EN_SPEC> {
...
#[doc = "OTP device write-enable signal\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`write_en::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`write_en::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
