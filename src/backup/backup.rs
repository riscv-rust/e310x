...
pub type R = crate::R<BACKUP_SPEC>;
#[doc = "Register `backup[%s]` writer"]
pub type W = crate::W<BACKUP_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<BACKUP_SPEC> {
...
#[doc = "Backup Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`backup::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`backup::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
