...
pub struct R(crate::R<CMP2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMP2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMP2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMP2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `cmp2` writer"]
pub struct W(crate::W<CMP2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMP2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMP2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMP2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type VALUE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP2_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
